...
(()=>{
  ...
  async function loadOptions(){const r=await api('/api/accounting/seller-financial-performance/filters');preserveSelections('#sfSeller',optionRows(r.sellers));preserveSelections('#sfCategory',optionRows(r.categories));preserveSelections('#sfPool',optionRows(r.ratePools));preserveSelections('#sfStore',optionRows(r.stores));}
