...
(()=>{
  ...
  function statusFa(status){return({draft:'پیش‌نویس',pending:'در انتظار تأیید',approved:'مصوب',rejected:'ردشده',retired:'بازنشسته',historical_frozen:'تاریخی و منجمد'})[status]||status||'نامشخص';}
