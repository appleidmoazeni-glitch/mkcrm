...
(()=>{
  ...
  async function mappingPage(){
    ...
    try{
      ...
      ['fgmFrom','fgmTo','fgmPool'].forEach(id=>{if(q(`#${id}`))q(`#${id}`).onchange=rerender;});syncMappingDependencies();
