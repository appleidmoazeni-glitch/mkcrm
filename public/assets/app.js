    ...
    try{
      ...
      document.querySelectorAll('.mc-resolve').forEach(button=>button.onclick=async()=>{
        ...
        try{
          ...
          const canFinalize=canDecide&&!['EXACT_OFFICIAL_PURCHASE_LAYER','SOURCE_HISTORY_INCOMPLETE','PENDING_PURCHASE_PRICE','PURCHASE_RETURN_CONFLICT','CONFLICT_REQUIRES_REVIEW'].includes(suggestion.sourceClass);
