...
function candidateDb(){return new MemoryDb({
  ...
  manualCostResolutions:[{resolutionId:'MCOST-1785779703360-79333248',schemaVersion:3,status:'approved',revision:3,deleted:false,itemGuid:'G-ASUS',itemCode:'10X1407920',manualCostExact:'612310000.000000',resolutionScope:'item',effectiveFrom:'14050101',effectiveTo:'',contentHash:'b'.repeat(64),legacyConsumptionReview:{status:'approved-for-fifo',reviewedBy:{username:'manager'},reason:'explicit FIFO-04 legacy test fixture'},createdBy:{username:'khedmati',role:'accounting'},approvedBy:{username:'admin',role:'admin'},approvedAt:new Date('2026-08-01T00:00:00Z')}],purchaseReturnResolutions:[],saleReturnResolutions:[],
