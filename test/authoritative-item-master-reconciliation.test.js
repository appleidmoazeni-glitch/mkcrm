...
test('authoritative full master accepts same-GUID rename and preserves identity with inactive history',async()=>{
  const database=new MemoryDb({itemCatalogAll:[{_id:'id-G-1',itemGuid:'G-1',itemCode:' OLD ',itemDescription:'Legacy row'}],purchaseHistoryDiscoveryQueue:[{canonicalIdentity:'guid:g1',itemGuid:'g-1',itemCode:'OLD'}]});
