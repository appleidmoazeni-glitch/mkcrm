...
async function fifoFacts(db,datasetId,filters={}){
  ...
  if(categoryGuid){const categoryPredicates=[{officialProductCategoryGuid:categoryGuid},{productCategoryGuid:categoryGuid}];if(clean(filters._resolvedCategoryName,300))categoryPredicates.push({officialProductCategoryName:clean(filters._resolvedCategoryName,300)},{productCategory:clean(filters._resolvedCategoryName,300)});authoritative.push({$or:categoryPredicates});}
